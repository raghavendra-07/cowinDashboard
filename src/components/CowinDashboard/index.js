...
class CowinDashboard extends Component {
  ...
  getVaccinationsData = async () => {
    ...
    const vaccinationDatApiUrl = 'https://apis.ccbp.in/covid-vaccination-data'
    const response = await fetch(vaccinationDatApiUrl)
  ...
  renderLoadingView = () => (
    <div className="loading-view" data-testid="loader">
      <Loader height={80} width={80} type="ThreeDots" color="#ffffff" />
    </div>
  )
